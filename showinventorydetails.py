...
def InventoryViewDetailsPanel(self):
    ...
    Label(Frame_Top, text="Inventory Details", font=("Goudy old style", 15, "bold"), fg="#FFFFFF",
          bg="#F98C6E").place(
        x=10, y=15)
    search_button = Button(Frame_Top, text="Checkout", font=("Goudy old style", 12), 
                          bg="#FFFFFF", fg="#F98C6E",
                          cursor="hand2",command=self.generate_qr_for_cart)
